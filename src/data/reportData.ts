  ...
  energy: [
    {
      ...
      advice: "먼저 스스로에게 '정말 고생 많았다'고 말해주세요. 하루 10분이라도 아무것도 하지 않고 그냥 숨 쉬는 시간을 가져보시길 바라요. 당신도 충분히 쉴 자격이 있습니다.",
      priority: "긴급"
    },
    {
      label: "간신히 하루하루 버티고 있어요.",
      analysis: "매일이 버거우시겠지만, 그래도 계속 버텨내고 계시는 당신이 정말 대단해요. 지금의 피로감은 당연한 거예요. 누구라도 이런 상황에서는 힘들 수밖에 없어요.",
      advice: "완벽하지 않아도 괜찮아요. 오늘 하루 작은 것 하나라도 본인을 위한 시간을 만들어보세요. 좋아하는 음악 한 곡 듣기, 따뜻한 차 한 잔 마시기도 좋습니다.",
      priority: "높음"
    },
    {
      label: "그럭저럭 괜찮은 편이에요.",
    ...
    },
    {
      ...
      analysis: "정말 멋지세요! 스스로를 잘 돌보고 계시는 것 같아요. 이런 긍정적인 에너지가 가족에게도 좋은 영향을 주고 계실 거예요.",
  ...
  support: [
    {
      ...
      advice: "혼자가 아니라는 걸 기억해주세요. 온라인 아빠 커뮤니티나 상담 서비스도 좋은 시작점이 될 수 있어요. 작은 발걸음부터 내딛어보시면 어떨까요?",
      priority: "긴급"
    },
    {
      ...
      advice: "처음엔 작은 것부터 시작해보세요. '오늘 좀 피곤하네' 같은 간단한 표현부터요. 상대방도 당신의 솔직함을 고마워할 거예요.",
      priority: "높음"
    },
    {
      label: "가끔 있는 편이에요.",
  ...
  time: [
    {
      ...
      advice: "죄책감 갖지 마세요. 나를 위한 시간은 사치가 아니라 필수예요. 5분이라도 좋으니 온전히 나만을 위한 순간을 만들어보세요.",
      priority: "긴급"
    },
    {
      label: "1시간이 채 안 돼요.",
      analysis: "늘 가족 먼저, 일 먼저이시겠지만, 당신의 마음도 충전이 필요해요. 지금까지 정말 많이 참고 견뎌오셨어요. 그런 희생정신이 정말 대단하지만, 당신도 쉴 권리가 있어요.",
      advice: "일주일에 한 번은 나만을 위한 시간을 선물해보세요. 혼자 산책하거나 좋아하는 책 읽기, 무엇이든 좋아요. 자신을 사랑하는 것도 가족을 사랑하는 일이에요.",
      priority: "높음"
    },
    {
      label: "가끔은 시간을 내려고 노력해요.",
      analysis: "스스로를 돌보려고 노력하시는 모습이 보여요. 그런 노력 자체가 정말 소중해요. 바쁜 일상 속에서도 자신을 생각하는 마음을 갖고 계시는 것이 참 멋져요.",
      advice: "지금처럼 자신을 위한 시간을 만드는 노력을 계속해주세요. 그런 시간이 결국 가족에게도 더 좋은 당신이 되는 데 도움이 될 거예요.",
      priority: "보통"
    },
    {
      label: "충분히 갖고 있다고 생각해요.",
      analysis: "정말 훌륭한 자기관리를 하고 계시네요! 자신을 소중히 여기는 마음이 느껴져요. 일과 가정, 그리고 자신의 균형을 잘 맞추고 계시는 것 같아요.",
      advice: "지금의 좋은 습관을 꼭 유지해주세요. 다른 아빠들에게도 좋은 모범이 되실 것 같아요. 자신을 사랑하는 아빠가 가족에게도 최고의 선물이에요.",
      priority: "양호"
    }
  ],
  needs: [
    "마음을 털어놓고 싶으시군요. 당연한 마음이에요. 처음엔 일기를 써보시는 것도 좋고, 익명의 온라인 공간에서 시작해보는 것도 방법이에요. 당신의 이야기를 들어줄 사람들이 분명 있어요.",
    "스트레스와 화가 쌓이셨군요. 정말 이해해요. 심호흡을 깊게 해보시고, 10분이라도 밖으로 나가 걸어보세요. 화가 날 때는 그 감정을 인정하고 '지금 화가 나는구나' 하고 받아들이는 것부터 시작해보세요.",
    "소중한 사람과의 관계를 개선하고 싶으시는군요. '당신 때문에'보다는 '내가 느끼기에는'으로 시작하는 대화를 연습해보세요. 비난보다는 내 마음을 전달하는 거예요.",
    "진짜 '나'를 찾고 싶으시는군요. 아빠이기 전에 한 사람의 인간으로서 말이죠. 어릴 때 좋아했던 것들, 꿈꿨던 것들을 떠올려보세요. 아주 작은 취미라도 다시 시작해보는 건 어떨까요?",
